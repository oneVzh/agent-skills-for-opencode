...
This file provides guidance to AI coding agents when working on this project. It lives at `AGENTS.md` in the project root and applies only to this project. The global `~/.config/opencode/AGENTS.md` takes effect across all projects; this file overrides it for project-specific instructions.

## Project Configuration Overview

OpenCode project-level configuration uses the project root (`AGENTS.md`) and the `.opencode/` directory. This directory contains three asset directories:
