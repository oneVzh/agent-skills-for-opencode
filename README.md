...
**Production-grade engineering skills for AI coding agents — adapted for OpenCode.**
...
This project is a fork of [addyosmani/agent-skills](https://github.com/addyosmani/agent-skills), adapted for OpenCode. The original project's OpenCode integration instructions were outdated, so this fork fixes those issues to ensure skills, commands, and agents work correctly with OpenCode.

### Installation

OpenCode supports two configuration modes:

**Global configuration** — place files in `~/.config/opencode/`, shared across all projects:

```bash
git clone https://github.com/oneVzh/agent-skills-for-opencode.git
cp -r agent-skills-for-opencode/skills/ ~/.config/opencode/skills/
cp -r agent-skills-for-opencode/agents/ ~/.config/opencode/agents/
cp -r agent-skills-for-opencode/commands/ ~/.config/opencode/commands/
cp agent-skills-for-opencode/AGENTS.md ~/.config/opencode/AGENTS.md
```

**Project-level configuration** — place files in your project's `.opencode/` directory, scoped to that project only:

```bash
git clone https://github.com/oneVzh/agent-skills-for-opencode.git
cp -r agent-skills-for-opencode/skills/ your-project/.opencode/skills/
cp -r agent-skills-for-opencode/agents/ your-project/.opencode/agents/
cp -r agent-skills-for-opencode/commands/ your-project/.opencode/commands/
cp agent-skills-for-opencode/AGENTS-project.md your-project/AGENTS.md
```

> Project-level `.opencode/` config overrides the global `~/.config/opencode/` config for matching files.
